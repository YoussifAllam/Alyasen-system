...
class InvoiceMaterial(models.Model):
    invoice = models.ForeignKey(
        SupplierInvoice, on_delete=models.CASCADE, related_name="materials"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["invoice", "material_name"], name="unique_invoice_material"
            )
        ]


class InvoicePayment(models.Model):
    supplier_fk = models.ForeignKey(MaterialSupplier, on_delete=models.CASCADE)
