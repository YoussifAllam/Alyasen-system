from ..models import SupplierInvoice, InvoiceMaterial,Supplier
from ..tasks import celery_tasks

def increase_invoice_total_amount(invoice_instance: SupplierInvoice, material_instance: InvoiceMaterial):
...
def decrease_invoice_total_amount(invoice_instance: SupplierInvoice, material_total_buy_price: float):
...
def update_supplier_balance(invoice_total_amount: float , paid_amount: float , supplier_instance: Supplier):
    ...
    celery_tasks.create_supplier_payment_record.delay(supplier_instance.id, paid_amount, "")
