...
# from ..serializers.OutputSerializers import TransactionsLogSerializer
...
#     serializer = TransactionsLogSerializer(paginated_objects, many=True, context={"request": request})
